...
contract SafeSwapNftTest is ChainConfigTestHelper, SafeSwapTestHelper {
    ...
    public
    {
        ...
        _publish_config_address( SAFESWAP_NFT_SIGNING_DESCRIPTOR_KEY, address(new SafeSwapNftSigningDescriptor()) );
    ...
    external
    {
        _publish_config_address( SAFESWAP_NFT_SIGNING_DESCRIPTOR_KEY, _ADDRESS_WITHOUT_CODE );
