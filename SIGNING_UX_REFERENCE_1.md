...
Message
  ...
  protocol: 0x2222222222222222222222222222222222222222
  sS__SWAP__Ss
    Pay:      at most 1.2 WETH
    Receive:  exactly 4,000 USDC
    Pool:     0.3% base fee, 50% rebate, tick spacing 60
    Warning:  >>  Check protocol and token addresses  <<
    USDC:     0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48
```
...
Message
  ...
  sS__CREATE_POSITION__Ss
    Deposit:   up to 1.25 WETH and 4,200 USDC
    Minimum:   1.24 WETH and 4,180 USDC
    Liquidity: 340282366920938463463374607431768211
    Range:     2,850 to 3,150 USDC per WETH
    Price:     3,002.5 USDC per WETH
    Pool:      0.3% base fee, 50% rebate, tick spacing 60
    Warning:   >>  Check protocol and token addresses  <<
...
Message
  ...
  sS__ADD_LIQUIDITY__Ss
    ...
    Deposit:   up to 0.5 WETH and 1,680 USDC
    Minimum:   0.495 WETH and 1,660 USDC
...
Message
  ...
  sS__REMOVE_LIQUIDITY__Ss
    ...
    Receive:  at least 0.245 WETH and 830 USDC
    Pool:     0.3% base fee, 50% rebate, tick spacing 60
    Warning:  >>  Check protocol and token addresses  <<
    WETH:     0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2
    USDC:     0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48
...
Message
  ...
  sS__COLLECT_FEES__Ss
    Position: LP #9166523579416187058
    Receive:  at least 0.01 WETH and 42 USDC
    Pool:     0.3% base fee, 50% rebate, tick spacing 60
    Warning:  >>  Check protocol and token addresses  <<
    WETH:     0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2
    USDC:     0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48
